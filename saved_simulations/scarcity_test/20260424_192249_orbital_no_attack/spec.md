# Swarm Shield — scarcity_test
_Run: 20260424_192249_batch_

## TL;DR
Ablation: shield_test with only 5 particles. Tests whether the attack-swarm behavior survives under scarcity, or whether it requires quorum.
...
- Avg shield coverage (post-threat): 0.71
- Avg cohesion (mean nearest-neighbor distance): 1.56
- Final intent distribution: {'protect': 2, 'explore': 0, 'retreat': 0, 'other': 3}

...
_Run: 20260428_142720_muk_indifferent_s33_
...
- Response time: 24 steps after first threat
- Max shield coverage: 0.60
- Avg shield coverage (post-threat): 0.22
- Avg cohesion (mean nearest-neighbor distance): 0.60
- Final intent distribution: {'protect': 11, 'explore': 2, 'retreat': 0, 'other': 7}
...
## Notes
Mukanshin test: no-relation condition (paired with muk_guardian seed 33)

...
_Run: 20260428_133033_muk_indifferent_s11_
...
- Response time: 3 steps after first threat
- Max shield coverage: 1.00
- Avg shield coverage (post-threat): 0.44
- Avg cohesion (mean nearest-neighbor distance): 0.59
- Final intent distribution: {'protect': 14, 'explore': 2, 'retreat': 0, 'other': 4}
...
## Notes
Mukanshin test: no-relation condition (paired with muk_guardian seed 11)

...
_Run: 20260428_135843_muk_indifferent_s22_
...
- Avg shield coverage (post-threat): 0.30
- Avg cohesion (mean nearest-neighbor distance): 0.54
- Final intent distribution: {'protect': 6, 'explore': 2, 'retreat': 0, 'other': 12}
...
## Notes
Mukanshin test: no-relation condition (paired with muk_guardian seed 22)

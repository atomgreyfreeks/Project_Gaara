...
_Run: 20260428_223636_test_pure_mukanshin_s11_
...
- Max shield coverage: 0.15
- Avg shield coverage (post-threat): 0.02
- Avg cohesion (mean nearest-neighbor distance): 0.46
- Final intent distribution: {'protect': 2, 'explore': 2, 'retreat': 0, 'other': 16}
...
## Notes
Pure mukanshin: identity neutral, broadcast neutralized, no purpose. The framework predicts field collapse — particles fail to engage with the threat at all.
